...
// class constructor
    ...
    function install()
    {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('MD5 Hash Value', 'MODULE_PAYMENT_REMIBIT_MD5_HASH', '', 'The MD5 Hash Value used for your RemiBit account.', '6', '0', now())");
